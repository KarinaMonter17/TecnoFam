...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO usuarios (nombre, apellido, telefono, email, nombre_tutor, telefono_tutor, address, danza, pintura, cocina, ninguno)
    VALUES ('$nombre', '$apellido', '$telefono', '$email', '$nombre_tutor', '$telefono_tutor', '$address', $danza, $pintura, $cocina, $ninguno)";
