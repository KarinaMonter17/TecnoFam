...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE usuarios SET nombre = '$nombre', apellido = '$apellido', telefono = '$telefono', email = '$email', nombre_tutor = '$nombre_tutor', telefono_tutor = '$telefono_tutor', address = '$address', preferencia1 = $preferencia1, preferencia2 = $preferencia2, preferencia3 = $preferencia3, preferencia4 = $preferencia4 WHERE nombre = '$user_name'";
